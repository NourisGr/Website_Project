...
<body>
    ...
    if ($_SESSION["Language"] == "EN") {
        navbar("address", "address.php", ["Home ", "About ", "Contact ", "Email ", "Phone ", "Address ", "Products ", "ShopingCart", "Register "], "EN");
    ?>
    ...
    <?php
        ...
        navbar("address", "address.php", ["Αρχική", "Σχετικά", "Τρόποι Επικοινωνιάς", "Email", "Κινήτο", "Διεύθυνση", "Προϊόντα", "Καρτέλα", "Εγγραφή"], "GR");
    ?>
        <img src="include/images/contactus.png" class="contactimg" alt="contact us">
        <div class="contactpage">
